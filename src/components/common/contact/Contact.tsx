...
import Map from "./Map";
// import { IconType } from "react-icons/fa6";
...
// const MarkComponent: React.FC<MarkComponentProps> = ({
//   lat,
//   lng,
//   icon,
//   text,
...
const Contact: React.FC = () => {
  ...
  // useEffect(() => {
  //   if (selectedPosition) {
  //     console.log(" Check selectedPosition :", selectedPosition);
  //     const getCoords = async () => {
  //       const result = await geocodeByAddress(selectedPosition);
  ...
  return (
    <div className="flex w-full ">
      <div className=" w-4/5">
        {/* <Map coords={coords} address={selectedPosition} /> */}
