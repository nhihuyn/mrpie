...
import DropDownLanguage from "./components/drop-down-langue";
...
const Header: React.FC = () => {
  ...
  return (
    <Layout>
      <HeaderAnt
        className="hidden md:flex items-center bg-white py-12 border-b-solid"
      ...
      >
        ...
        <div className="flex">
          ...
          <Link to={"/"}>
            <ShoppingCartOutlined className="text-2xl mr-5 w-full h-full text-black relative" />
          </Link>
