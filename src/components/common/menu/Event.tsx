...
const Event: React.FC<CustomSliderProps> = ({
  image,
  size = 200,
  IsStore = false,
  location,
    ...
    <div className={`bg-[#F0FDFF] h-[${height}px] w-[${size}px] rounded-lg`}>
      <div className="relative">
        ...
        <div className="flex justify-center absolute -bottom-4 left-0 right-0">
          <Link to="/promotion">
            <Button className="h-10 w-32 text-white font-bold flex items-center justify-center shadow-3xl bg-gradient-to-r from-[#EBA2D0]  to-[#CA8EEE] rounded-3xl px-4 py-2">
              {t("Chi tiết")}
            </Button>
          </Link>
        </div>
